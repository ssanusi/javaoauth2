package com.ssanusi.javaoauth2.handlers;
...
import com.ssanusi.javaoauth2.models.ErrorDetail;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException rnfe)
    {
        ...
        errorDetail.setTittle("Resource Not Found");
    ...
    public ResponseEntity<?> handleResourceFoundException(ResourceFoundException rfe)
    {
        ...
        errorDetail.setTittle("Unexpected Resource");
                                                        ...
                                                        WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Parameter Type Mismatch");
                                                                   ...
                                                                   WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.NOT_FOUND.value());
        errorDetail.setTittle(ex.getRequestURL());
                                                                         ...
                                                                         WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.NOT_FOUND.value());
        errorDetail.setTittle(ex.getMethod());
        errorDetail.setDetail(request.getDescription(true));
                                                                  ...
                                                                  WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Validation Errors");
                                                                  ...
                                                                  WebRequest request)
    {
        ...
        errorDetail.setTittle("Message Not Readable");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                                     ...
                                                                     WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(status.value());
        errorDetail.setTittle("Method not supported");
                                                               ...
                                                               WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle(ex.getVariableName() + " Missing Path Variable");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                             ...
                                                             WebRequest request)
    {
        ...
        errorDetail.setTittle("Internal Server Error");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                                      ...
                                                                      WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Media Type Not Acceptable");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                                          ...
                                                                          WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Missing Servlet Request Parameter");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                                          ...
                                                                          WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Servlet Request Binding Exception");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                                  ...
                                                                  WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Conversion Not Supported");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                                  ...
                                                                  WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Message Not Writable");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                                     ...
                                                                     WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Missing Servlet Request");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                         ...
                                                         WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Bind Exception");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                                        ...
                                                                        WebRequest webRequest)
    {
        ...
        errorDetail.setTittle("Async Request Timeout");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
                                                         ...
                                                         HttpServletRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date().getTime());
        errorDetail.setStatus(HttpStatus.BAD_REQUEST.value());
        errorDetail.setTittle("Exception");
        errorDetail.setDetail(ex.getMessage());
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
